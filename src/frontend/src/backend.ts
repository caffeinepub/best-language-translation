...
export class Backend implements backendInterface {
    ...
    async getAllHistory(): Promise<Array<Record_>> {
        if (this.processError) {
            try {
    ...
    async saveTranslation(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveTranslation(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
